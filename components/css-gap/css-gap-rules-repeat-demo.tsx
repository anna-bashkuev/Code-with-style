    ...
    >
      ...
      <div className="demo-wrap">
        ...
        <div style={{ marginBottom: "1rem" }}>
          <p
            style={{ margin: "0 0 0.5rem", fontSize: "0.75rem", color: "#666" }}
          >
            Pattern steps — each step is one rule definition, cycled across all
            gaps:
          </p>
          <div
            ...
            {steps.map((step, i) => (
              <div key={i} className="step">
                <span
                  ...
                  style={{ fontSize: "0.7rem", color: "#e6e3e3", minWidth: 44 }}
                >
                  step {i + 1}
                </span>
        ...
        >
          <p
            style={{ margin: "0 0 0.35rem", fontSize: "0.7rem", color: "#555" }}
          >
            resolved CSS:
          </p>
          <code
      ...
      <div className="note">
        ...
        <span>
          <code>repeat(auto, 1px dashed magenta, 5px dashed magenta)</code>{" "}
          cycles the two-step pattern across every gap automatically — no need
          to list each gap individually. Use a fixed count like{" "}
          <code>repeat(2, ...)</code> to apply the pattern only a set number of
          times, leaving remaining gaps unstyled.
        </span>
      </div>
    </ComponentPreview>
  );
